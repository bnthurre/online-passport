...
const DailyApplicants = () => {
  ...
  document.title = "Daily Applidants";
...
//   );
  ...
  const filteredItems = dailyApplicants?.filter(
    (item) =>
      item.fullname &&
...
const load = () => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Daily Applicants" pageTitle="Applicants" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <Row className="g-4 mb-3">
                    <Col className="col-sm-auto">
                      <div>
                        <div>
                          <ToastContainer />
                          <h4 className="card-title mb-0">Daily Applicants</h4>
                        </div>
                      </div>
                    </Col>
...
export default DailyApplicants;
